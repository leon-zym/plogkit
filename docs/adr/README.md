...
| [0011](0011-testing-strategy.md)                          | 测试策略：五层金字塔与 BDD 方法论                              | 部分修订 | [0019](0019-cross-platform-maestro-e2e.md)、[0020](0020-ci-lifecycle-and-main-ruleset.md)、[0023](0023-export-preset-catalog-and-pipeline.md)、[0026](0026-test-runners-by-runtime.md)、[0040](0040-scenario-verification-traceability.md)  |
| [0012](0012-e2e-tooling-maestro.md)                       | E2E 工具：Maestro 模拟器主力 + Device Hub 真机手动冒烟         | 部分修订 | [0019](0019-cross-platform-maestro-e2e.md)、[0040](0040-scenario-verification-traceability.md)                                                                                                                                              |
| [0013](0013-doc-system.md)                                | 文档体系：ADR + specs + guides，暂不引入 OpenSpec              | 部分修订 | [0038](0038-document-ownership-contracts.md)、[0040](0040-scenario-verification-traceability.md)                                                                                                                                            |
...
| [0038](0038-document-ownership-contracts.md)              | 以 ownership map 深化文档体系                                  | 部分修订 | [0040](0040-scenario-verification-traceability.md)                                                                                                                                                                                          |
| [0039](0039-native-node-orchestration-tests.md)           | 原生 Node 宿主编排器的测试运行器边界                           | 已接受   | 无                                                                                                                                                                                                                                          |
| [0040](0040-scenario-verification-traceability.md)        | Scenario 验证证据采用跨层多对多映射                            | 已接受   | 无                                                                                                                                                                                                                                          |
