...
| [0042](0042-controlled-standalone-simulator-e2e.md)       | 受控的 standalone 模拟器 E2E                                   | 部分修订 | [0043](0043-layered-ios-simulator-readiness.md)、[0045](0045-sanitized-e2e-diagnostic-evidence.md)                                                                                                                                         |
| [0043](0043-layered-ios-simulator-readiness.md)           | iOS Simulator 使用分层 readiness                               | 部分修订 | [0044](0044-ios-app-service-readiness.md)                                                                                                                                                                                                   |
| [0044](0044-ios-app-service-readiness.md)                 | iOS Simulator readiness 覆盖应用服务                           | 已接受   | 无                                                                                                                                                                                                                                          |
| [0045](0045-sanitized-e2e-diagnostic-evidence.md)         | iOS E2E 系统诊断证据先脱敏再保留                               | 已接受   | 无                                                                                                                                                                                                                                          |
