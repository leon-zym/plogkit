...
| --- | --- | --- | --- | --- |
| [`docs/adr/`](adr/) | 长期有效、跨 module 或难逆转的架构与工程治理决定，以及决定的演进关系 | 功能交付状态、实施进度、故障调查、工作清单 | 在调用方附近概述仍生效的约束，并链接对应 ADR | interface、seam、数据兼容性或工程约束发生长期变化时新增 ADR |
...
ADR 与 spec 的具体结构契约分别见 [`docs/adr/README.md`](adr/README.md) 和 [`docs/specs/README.md`](specs/README.md)。文档语言规则见 [ADR 0014](adr/0014-language-policy.md)，ownership 与 repo-local verifier 决定见 [ADR 0038](adr/0038-document-ownership-contracts.md)。
