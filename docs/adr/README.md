...
| [0043](0043-layered-ios-simulator-readiness.md)           | iOS Simulator 使用分层 readiness 与单一 Maestro 生命周期       | 已接受   | 无                                                                                                                                                                                                                                          |
| [0045](0045-sanitized-e2e-diagnostic-evidence.md)         | iOS E2E 使用隔离且脱敏的公开证据集                             | 已接受   | 无                                                                                                                                                                                                                                          |
